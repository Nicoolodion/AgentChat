...
/**
 * GET /api/locale — cookie-authed read of the user's locale profile (used by
 * the /m web route's locale picker). Seeded from Accept-Language on first read.
 */
...
/**
 * POST /api/locale — set the user's country/language/timezone (locale picker in
 * /m). CSRF-protected like other cookie-authed mutating endpoints.
 */
